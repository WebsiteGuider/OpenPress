...
class Category
{
  ...
  */
  ...
  public static function getById( $id ) {
    ...
    $sql = "SELECT * FROM op_categories WHERE id = :id";
    $st = $conn->prepare( $sql );
  ...
  */
  ...
  public function insert() {
    ...
    // Insert the Category
    $conn = new PDO( DB_HOST, DB_USERNAME, DB_PASSWORD );
    $sql = "INSERT INTO op_categories ( name, description ) VALUES ( :name, :description )";
    $st = $conn->prepare ( $sql );
  ...
  */
  ...
  public function update() {
    ...
    // Update the Category
    $conn = new PDO( DB_HOST, DB_USERNAME, DB_PASSWORD );
    $sql = "UPDATE op_categories SET name=:name, description=:description WHERE id = :id";
    $st = $conn->prepare ( $sql );
    $st->bindValue( ":name", $this->name, PDO::PARAM_STR );
    $st->bindValue( ":description", $this->description, PDO::PARAM_STR );
  ...
  */
  ...
  public function delete() {
    ...
    // Delete the Category
    $conn = new PDO( DB_HOST, DB_USERNAME, DB_PASSWORD );
    $st = $conn->prepare ( "DELETE FROM op_categories WHERE id = :id LIMIT 1" );
    $st->bindValue( ":id", $this->id, PDO::PARAM_INT );
    $st->execute();
    $conn = null;
  }
